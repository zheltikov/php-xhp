...
abstract class ParserAbstract implements Parser
{
    ...
    protected array $endAttributeStack;
     ...
     *
     * @return \Zheltikov\Xhp\Parser\Node|null Array of statements (or null non-throwing error handler is used and
                    ...
                    switch ($this->errorState) {
                        ...
                        case 2:
                            ...
                            while (!(
                                    ...
                                    || ($state < $this->YY2TBLSTATE
                                        && ($idx = $this->actionBase[$state + $this->numNonLeafStates]
                                                   + $this->errorSymbol) >= 0
                                        && $idx < $this->actionTableSize
                                        && $this->actionCheck[$idx] === $this->errorSymbol)
                                )
                                   || ($action = $this->action[$idx])
                                      === $this->defaultAction) { // Not totally sure about this
                                if ($stackPos <= 0) {
